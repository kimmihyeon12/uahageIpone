          ...
          : Scaffold(
              body: Column(
                ...
                children: [
                  ...
                  //hearts
                  Container(
                    margin: EdgeInsets.fromLTRB(79 / screenWidth,
                        71 / screenHeight, 79 / screenWidth, 0),
                    child: Image.asset("./assets/secondPage/hearts.png"),
                  ),

                  // kakao
                  Container(
                    margin: EdgeInsets.fromLTRB(96 / screenWidth,
                        69 / screenHeight, 94 / screenWidth, 0),
                  ...
                  Container(
                    margin: EdgeInsets.fromLTRB(96 / screenWidth,
                        53 / screenHeight, 94 / screenWidth, 0),
                    height: 195 / screenHeight,
                    child: InkWell(
                      onTap: () {
                        print("Naver login");
