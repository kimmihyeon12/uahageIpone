            ...
            body: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    margin: EdgeInsets.fromLTRB(73 / screenWidth,
                        78 / screenHeight, 75 / screenWidth, 39 / screenHeight),
 ...
 5. 회사는 본 약관을 변경할 경우에는 변경된 약관과 사유를 적용일자 1주일 전까지 서비스 홈페이지에 게시하거나 이용자에게 전자적 형태(전자우편, SMS 등)로 공지하며, 이용자가 그 기간 안에 이의제기가 없거나, 본 서비스를 이용할 경우 이를 승인한 것으로 봅니다.""",
                        ...
                        Align(
                          ...
                          child: IconButton(
                            ...
                            icon:
                                Image.asset("./assets/agreementPage/x_btn.png"),
                          ),
                        ),
                      ],
                    ),
 ...
 5. 회사는 본 약관을 변경할 경우에는 변경된 약관과 사유를 적용일자 1주일 전까지 서비스 홈페이지에 게시하거나 이용자에게 전자적 형태(전자우편, SMS 등)로 공지하며, 이용자가 그 기간 안에 이의제기가 없거나, 본 서비스를 이용할 경우 이를 승인한 것으로 봅니다.""",
                          ...
                          Align(
                            ...
                            child: IconButton(
                              ...
                              icon: Image.asset(
                                  "./assets/agreementPage/x_btn.png"),
                            ),
                          ),
                        ],
                      ),
