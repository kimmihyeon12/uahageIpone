...
var connection = mysql.createConnection({
  host: "uahage1.c7qbk7qns6ot.ap-northeast-2.rds.amazonaws.com",
  user: "admin",
  password: "hohocom!",
  database: "uahage",
});
...
app.get("/searchCategory", (req, res) => {
  ...
  long = Math.abs(parseFloat(req.query.long));
  // console.log(req.query);
  // console.log(req.query.menu == "true" ? null : "o");
  // console.log(req.query.bed === "true" ? null : "o");
  let menu = req.query.menu;
  let bed = req.query.bed;
  let tableware = req.query.tableware;
  let meetingroom = req.query.meetingroom;
  let diapers = req.query.diapers;
  let playroom = req.query.playroom;
  let carriages = req.query.carriages;
  let nursingroom = req.query.nursingroom;
  ...
  // console.log(sql1);
  // (menu = menu === "true" ? "is null" : "='○'"),
  //   (bed = bed === "true" ? "is null" : "='○'"),
  //   (tableware = tableware === "true" ? "is null" : "='○'"),
  //   (meetingroom = meetingroom === "true" ? "is null" : "='○'"),
  //   (diapers = diapers === "true" ? "is null" : "='○'"),
  //   (playroom = playroom === "true" ? "is null" : "='○'"),
  //   (carriages = carriages === "true" ? "is null" : "='○'"),
  //   (nursingroom = nursingroom === "true" ? "is null" : "='○'"),
  //   (chair = chair === "true" ? "is null" : "='○'");
...
app.get("/getList/:liststringdata", (req, res) => {
  ...
  let sql = "SELECT * FROM " + liststringdata; // + " limit 10 offset " + maxCount + ";";
  console.log(sql);
